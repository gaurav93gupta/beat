const video = document.getElementById('video');
        ...
        function sendDataToGoogleForm(qrCode, lat, lon) {
            ...
            formData.append('entry.728038232', qrCode); // Replace with your Google Form field entry ID
            formData.append('entry.197965276', `${lat},${lon}`); // Replace with your Google Form field entry ID

            fetch('https://docs.google.com/forms/d/e/1FAIpQLSfVBk6kGp8SGaUuZz7n58oRg40OBXm0jRfjwHOj9b1hJopoLA/formResponse?', {
                method: 'POST',
                body: formData,
                mode: 'no-cors'
            }).then(() => {
